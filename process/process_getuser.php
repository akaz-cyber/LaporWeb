...
$query = "SELECT id_user, username, nama_lengkap, email, tempat_tinggal, no_telp, role_id, dibuat_kapan, tanggal_lahir, penyandang_disabilitas, jenis_kelamin FROM users";
