...
<head>
    ...
    <meta name="keywords" content="UAS WEB PHP UTB">
    <meta name="description" content="UAS WEB PHP UTB">
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <main class="container mt-5">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 ">
                <p>
                <h2>Silahkan masuk terlebih dahulu untuk melapor</h2>
                </p>
                <form action="/LaporWeb/process_login" method="POST">
                    <div class="form-group mb-5"> <label for="email">Email:</label> <input type="email" class="form-control"
                    ...
                    <button type="submit" class="btn btn-danger mt-5 p-3 w-100 fs-4 fw-bold">Login</button>
                </form>
