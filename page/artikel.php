	...
	<div class="container my-5">
		...
		<div class="row mb-4">
			...
			<div class="col-md-8 mb-5">
				<img src="../page/img/eminem.jpg" class="img-fluid rounded img-main" alt="Main news image" />
			...
			<div class="col-md-4">
				...
				<div class="card-thumbnail d-flex align-items-center mb-3">
					<img src="../page/img/eminem.jpg" alt="Thumbnail 1" class="rounded">
					<div class="ms-3">
				...
				<!-- Thumbnail Card 2 -->
				<div class="card-thumbnail d-flex align-items-center mb-3">
					<img src="../page/img/news2.jpeg" alt="Thumbnail 2" class="rounded">
					<div class="ms-3">
				...
				<!-- Thumbnail Card 3 -->
				<div class="card-thumbnail d-flex align-items-center mb-3">
					<img src="../page/img/news2.jpeg" alt="Thumbnail 3" class="rounded">
					<div class="ms-3">
						<p class="mb-1 fw-bold text-truncate-2">Lorem Ipsum is simply dummy text of the printing</p>
						<button class="btn btn-sm btn-red">Selengkapnya</button>
					</div>
		...
		<div class="row gy-4">
			<div class="col-md-4">
				<div class="card">
					<img src="../page/img/news2.jpeg" alt="News 1" class="img-fluid rounded">
					<div class="card-body">
			...
			<div class="col-md-4">
				<div class="card">
					<img src="../page/img/news2.jpeg" alt="News 2" class="img-fluid rounded">
					<div class="card-body">
						<h5 class="card-title">Lorem Ipsum is simply dummy text</h5>
						<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry...</p>
						<p class="text-muted">By NEWSPORTAL.ID • 07 Jan, 2025</p>
			...
			<div class="col-md-4">
				<div class="card">
					<img src="../page/img/news2.jpeg" alt="News 3" class="img-fluid rounded">
					<div class="card-body">
						<h5 class="card-title">Lorem Ipsum is simply dummy text</h5>
						<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry...</p>
						<p class="text-muted">By NEWSPORTAL.ID • 07 Jan, 2025</p>
